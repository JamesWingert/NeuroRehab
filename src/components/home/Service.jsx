...
import insomnia from '/public/stock 3.jpeg';
import physical from '/public/stock2.jpeg';
        ...
        {/* <div className='mb-24 grid grid-cols-1 flex-col-reverse items-center gap-y-10 gap-x-10 rounded-2xl border border-wcyan/20 bg-white p-2 shadow-xl md:grid-cols-2 md:gap-y-32 md:gap-x-24 md:p-5'> */}
          {/* <div className='order-none md:order-2  '>
            ...
            <ul className='mb-5 text-center text-base text-gray-600 sm:text-left md:text-lg '>
              ...
              <li className='flex items-center text-center'>
                <CheckIcon className='h-5 w-5 text-wcyan ' /> Insomnia,
                Parasomnia
              </li>
              <li className='flex items-center text-center'>
                <CheckIcon className='h-5 w-5 text-wcyan ' /> PNES, PTSD,
                Pseudoseizure
              </li>
            </ul>
            <Link href='/services' passHref>
